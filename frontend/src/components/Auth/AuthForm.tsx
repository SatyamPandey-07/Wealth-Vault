...
export const AuthForm: React.FC<{ mode?: "login" | "register" }> = ({ mode = "login" }) => {
  ...
  const handleRegisterSubmit = async (data: RegisterFormData) => {
    setAuthError("");
    // Store form data and show profile setup
  ...
  if (showProfileSetup) {
    ...
    return (
      <ProfileSetup
        onComplete={(d: UserProfile) => signUp(email, password, d.firstName, d.lastName)}
        userEmail={email}
      />
    );
  }
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl bg-white dark:bg-slate-900/50 border focus:ring-2 focus:ring-primary text-gray-900 dark:text-white outline-none ${loginForm.formState.errors.email ? 'border-red-500' : 'border-gray-200 dark:border-slate-600'
                              }`}
                            type="email"
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl bg-white dark:bg-slate-900/50 border focus:ring-2 focus:ring-primary text-gray-900 dark:text-white outline-none ${loginForm.formState.errors.password ? 'border-red-500' : 'border-gray-200 dark:border-slate-600'
                              }`}
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl bg-white dark:bg-slate-900/50 border focus:ring-2 focus:ring-primary text-gray-900 dark:text-white outline-none ${registerForm.formState.errors.username ? 'border-red-500' : 'border-gray-200 dark:border-slate-600'
                              }`}
                            type="text"
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl bg-white dark:bg-slate-900/50 border focus:ring-2 focus:ring-primary text-gray-900 dark:text-white outline-none ${registerForm.formState.errors.email ? 'border-red-500' : 'border-gray-200 dark:border-slate-600'
                              }`}
                            type="email"
                            placeholder="name@example.com"
                          />
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`block w-full px-4 py-3 rounded-xl bg-white dark:bg-slate-900/50 border focus:ring-2 focus:ring-primary text-gray-900 dark:text-white outline-none ${registerForm.formState.errors.password ? 'border-red-500' : 'border-gray-200 dark:border-slate-600'
                              }`}
                            type={showPassword ? "text" : "password"}
                        ...
                        <PasswordStrengthMeter password={registerPassword || ""} showRequirements={true} />
                      </div>
                      <Button disabled={loading} type="submit" className="w-full py-3 bg-primary hover:bg-primary-dark text-white rounded-xl font-semibold shadow-lg transition-transform active:scale-95">
                        Create Account
                      </Button>
